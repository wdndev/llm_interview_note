...
![](image/image_mGr3tRn3J4.png)

**BF16**

**BF16和FP16都是混合精度训练中使用的浮点数表示格式**。

![](image/image_RKAT_h7mte.png)
...
![](image/image_jok5n2AIh4.png)

![](image/image_uL13NyMDJd.png)
...
![](image/image_QfURAd1CCS.png)

![](image/image_Bd5j9Al4iE.png)

![](image/image_Kjl4wcZYP7.png)

在DeepSpeed中，一般使用ZeRO-1就足够了。

![](image/image_81QxbidH_S.png)
